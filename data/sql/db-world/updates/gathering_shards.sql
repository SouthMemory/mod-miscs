...
INSERT INTO `npcbots_acore_world`.`gathering_shards` (`target_item_id`, `shards_item_id`, `skill_level_required`, `skill_type`, `target_item_name`) VALUES (23425, 58010, 325, 'mining', 'Adamantite Ore');
INSERT INTO `npcbots_acore_world`.`gathering_shards` (`target_item_id`, `shards_item_id`, `skill_level_required`, `skill_type`, `target_item_name`) VALUES (36909, 58011, 350, 'mining', 'Cobalt Ore');
INSERT INTO `npcbots_acore_world`.`gathering_shards` (`target_item_id`, `shards_item_id`, `skill_level_required`, `skill_type`, `target_item_name`) VALUES (2770, 58001, 1, 'mining', 'Copper Ore');
INSERT INTO `npcbots_acore_world`.`gathering_shards` (`target_item_id`, `shards_item_id`, `skill_level_required`, `skill_type`, `target_item_name`) VALUES (23424, 58009, 275, 'mining', 'Fel Iron Ore');
...
INSERT INTO `npcbots_acore_world`.`gathering_shards` (`target_item_id`, `shards_item_id`, `skill_level_required`, `skill_type`, `target_item_name`) VALUES (2776, 58005, 155, 'mining', 'Gold Ore');
INSERT INTO `npcbots_acore_world`.`gathering_shards` (`target_item_id`, `shards_item_id`, `skill_level_required`, `skill_type`, `target_item_name`) VALUES (2772, 58004, 125, 'mining', 'Iron Ore');
INSERT INTO `npcbots_acore_world`.`gathering_shards` (`target_item_id`, `shards_item_id`, `skill_level_required`, `skill_type`, `target_item_name`) VALUES (23426, 58012, 375, 'mining', 'Khorium Ore');
INSERT INTO `npcbots_acore_world`.`gathering_shards` (`target_item_id`, `shards_item_id`, `skill_level_required`, `skill_type`, `target_item_name`) VALUES (3858, 58006, 175, 'mining', 'Mithril Ore');
INSERT INTO `npcbots_acore_world`.`gathering_shards` (`target_item_id`, `shards_item_id`, `skill_level_required`, `skill_type`, `target_item_name`) VALUES (36912, 58013, 400, 'mining', 'Saronite Ore');
INSERT INTO `npcbots_acore_world`.`gathering_shards` (`target_item_id`, `shards_item_id`, `skill_level_required`, `skill_type`, `target_item_name`) VALUES (2775, 58003, 75, 'mining', 'Silver Ore');
INSERT INTO `npcbots_acore_world`.`gathering_shards` (`target_item_id`, `shards_item_id`, `skill_level_required`, `skill_type`, `target_item_name`) VALUES (10620, 58008, 245, 'mining', 'Thorium Ore');
INSERT INTO `npcbots_acore_world`.`gathering_shards` (`target_item_id`, `shards_item_id`, `skill_level_required`, `skill_type`, `target_item_name`) VALUES (2771, 58002, 65, 'mining', 'Tin Ore');
INSERT INTO `npcbots_acore_world`.`gathering_shards` (`target_item_id`, `shards_item_id`, `skill_level_required`, `skill_type`, `target_item_name`) VALUES (36910, 58014, 450, 'mining', 'Titanium Ore');
INSERT INTO `npcbots_acore_world`.`gathering_shards` (`target_item_id`, `shards_item_id`, `skill_level_required`, `skill_type`, `target_item_name`) VALUES (7911, 58007, 230, 'mining', 'Truesilver Ore');